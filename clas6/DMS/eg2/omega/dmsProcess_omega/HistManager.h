...
private:
    ...
    TH2D *Beta_Recalc;
    TH2D *scMassSquared;
    TH2D *scMassSquared_elecID;
    TH2D *scMassSquared_photID;
    TH2D *scMassSquared_elecIDphotID;
    TH2D *Theta_VS_Phi[7];
    TH2D *TotalMomentum;
...
public:
    ...
    TH2D* GetScMassSquared() { return scMassSquared; };
    TH2D* GetScMassSquared_elecID() { return scMassSquared_elecID; };
    TH2D* GetScMassSquared_photID() { return scMassSquared_photID; };
    TH2D* GetScMassSquared_elecIDphotID() { return scMassSquared_elecIDphotID; };
    ...
    //recon
    TH1D* GetPi0Mass_PhotIDcuts() { return Pi0Mass_PhotIDcuts; };
    TH1D* GetOmegaMass_AllCuts() { return OmegaMass_AllCuts; };
    TH2D* GetMass2Pions_VS_massOmega_NC(int index) { return mass2Pions_VS_massOmega_NC[index]; };
    TH1D* GetMass2Pions_VS_massOmega_NCX(int index) { return mass2Pions_VS_massOmega_NCX[index]; };
    TH2D* GetMass2Pions_VS_massOmega_EPC(int index) { return mass2Pions_VS_massOmega_EPC[index]; };
    TH1D* GetMass2Pions_VS_massOmega_EPCX(int index) { return mass2Pions_VS_massOmega_EPCX[index]; };
    TH2D* GetMass2Pions_VS_massOmega_EPOC(int index) { return mass2Pions_VS_massOmega_EPOC[index]; };
    TH1D* GetMass2Pions_VS_massOmega_EPOCX(int index) { return mass2Pions_VS_massOmega_EPOCX[index]; };

    void SetMass2Pions_VS_massOmega_NCX(int index);
    void SetMass2Pions_VS_massOmega_EPCX(int index);
    void SetMass2Pions_VS_massOmega_EPOCX(int index);
