...
TH1D *Mom_photID1;
TH1D *Mom_photID2;
TH1D *Mom_photID1_cut;
TH1D *Mom_photID2_cut;
TH1D *Beta_photID1;
TH1D *Beta_photID2;
TH1D *Beta_photID1_cut;
TH1D *Beta_photID2_cut;
TH1D *ECu_photID1;
TH1D *ECu_photID2;
TH1D *ECv_photID1;
TH1D *ECv_photID2;
TH1D *ECw_photID1;
TH1D *ECw_photID2;
TH1D *ECu_photID1_cut;
TH1D *ECu_photID2_cut;
TH1D *ECv_photID1_cut;
TH1D *ECv_photID2_cut;
TH1D *ECw_photID1_cut;
TH1D *ECw_photID2_cut;
TH1D *ECtime_ECl_Start_photID1;
TH1D *ECtime_ECl_Start_photID2;
TH1D *ECtime_ECl_photID1;
TH1D *ECtime_ECl_photID2;
TH1D *ECtime_ECl_photID1_cut;
TH1D *ECtime_ECl_photID2_cut;
TH1D *ECtime1;
TH1D *ECtime2;
TH1D *ECpath1;
TH1D *ECpath2;
